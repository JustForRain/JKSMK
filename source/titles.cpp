...
void sdTitlesInit()
{
    //for refresh games
    sdTitle.clear();
    if(fexists("/3ds/data/JKSV/titles"))
    {
        FILE *read = dbOpen("/3ds/data/JKSV/titles");
    ...
    else
    {
        ...
        FILE *db = dbCreate("/3ds/data/JKSV/titles");
...
{
    nandTitle.clear();
    if(fexists("/3ds/data/JKSV/nand"))
    {
        FILE *read = dbOpen("/3ds/data/JKSV/nand");
        u32 count = dbGetCount(read);
    ...
    else
    {
        ...
        FILE *nand = dbCreate("/3ds/data/JKSV/nand");
